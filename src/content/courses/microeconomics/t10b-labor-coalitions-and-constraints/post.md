...
<ul>
<li>Explain how unions and occupational licenses restrict entry to raise the earnings of admitted insiders while excluding the outsiders who would otherwise compete, and interpret the price of a transferable license as the capitalized value of that protected rent — a windfall captured once by whoever holds the license when the restriction is announced, with later buyers earning only an ordinary return.</li>
...
Who are those workers? Disproportionately the young, the inexperienced, and the least-skilled, the very people the policy is meant to help, because their value to an employer has not yet risen above the floor. The groups a floor exposes most are exactly the ones with the weakest bargaining position, whose one competitive chip was a willingness to start cheap and prove themselves; teenagers and the least-experienced are hit first.
...
The minimum wage has a darker consequence that overturns a common intuition. People assume a wage floor protects vulnerable workers from exploitation. In a competitive market it can do the opposite. When a less-favored worker may no longer offer to work for less, an employer who would otherwise have hired him because he was cheaper loses the reason to; forced to pay the same wage whomever he picks, that employer can now indulge a preference for the favored group at no extra cost. This is why rules mandating a common wage for "equal work" have so often been urged by the very insiders a lower-paid outsider might have underbid: a uniform wage protects the insiders' jobs by removing the outsider's ability to compete on price. A wage floor strips less-favored workers of their one competitive weapon, the willingness to accept lower pay, and so it can raise, not lower, the discrimination they face. (Triple the floor and you would only sharpen the effect.)

The general principle: **in a competitive market, discrimination is costly to the discriminator.** An employer who refuses productive workers from a group he dislikes forgoes the value they would add, and a rival who hires them gains an edge and can undersell him. The market punishes prejudice by making it expensive. The discipline is strongest where the employer spends his own money and faces rivals, and weakest where he is insulated from both: a sheltered, subsidized, or nonprofit employer can afford a bias that a competitive one would pay dearly to indulge.
...
The union logic, restrict the supply to raise insiders' pay, reappears in a respectable suit as occupational licensing. A license is a legal requirement to obtain permission before practicing a trade, sold to the public as protection against incompetents. Sometimes that is part of the story. But notice who lobbies for these rules: overwhelmingly the incumbents already in the trade, not the consumers they claim to protect. Such restrictions are typically sought by established suppliers who stand to gain from restraints on lower-cost or lower-quality rivals. The effect is to raise entry costs, thin competitors, and support incumbent incomes; the weight placed on consumer protection versus incumbent protection varies by rule. The same logic explains why a bar association's fixed minimum fees for routine legal work help established lawyers far more than a beginner hungry for clients.
...
The sharpest illustration is a transferable license, one its holder may sell. Picture a scheme that licenses the right to farm a certain crop on a given acre. A licensed acre earns more each year than an unlicensed one, because the license shields it from competitors, and that steady advantage is worth paying for. The moment the scheme is announced, the licensed land jumps in value, and the whole gain is captured once, by whoever happened to own the land right then. From then on the license changes hands at a price that reflects the protected earnings it confers. Real licenses behave exactly this way: a New York taxi license has sold for around $50,000, a liquor license in some states for more than $40,000, each figure the market's measure of the monopoly value of being allowed in, created not by serving customers better but by keeping competitors out. The political economy is the same insiders-versus-outsiders story as the union: the gains are concentrated on a small group of incumbents who fight hard to keep them, while the losses, higher prices and fewer choices for customers and lost opportunities for would-be entrants, are spread thin across millions who never organize to oppose them. That asymmetry helps explain why licensing persists even when its entry costs exceed its consumer-protection benefits.

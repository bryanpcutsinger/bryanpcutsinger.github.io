...
Because a voluntary trade leaves both sides better off, blocking one destroys something real. Yet blocking does not erase the value of controlling the scarce thing. It changes the form in which that value gets collected.
...
<figcaption><strong>Transaction costs are a wedge, and middlemen narrow it.</strong> Arranging a trade costs something, and the cost drives Sam's full price above what Joe nets: only the bottles whose gap in worths covers the cost change hands. The figure opens at the wall: costs of 0.8 bars a bottle swallow the whole gap, and both men sit at their 20-bottle start with every gain stranded. Drag the wedge tighter and trade comes to life: at 0.4, arranging it yourselves, 5 bottles move and the gray band is value the costs eat; at 0.2, the newcomer's rate, trade grows and both gains grow even after his cut; at zero every gainful bottle moves. Cheaper middlemen carry the market to the crossing.</figcaption>
</figure>

The figure prices the wall, and it opens there. If arranging the swap cost 0.8 bars a bottle, the whole gap between their starting worths, no bottle would move at all: every gain from trade exists on paper and none gets captured. Now suppose finding each other, judging the bottles, and settling terms costs Sam and Joe only 0.4 bars for every bottle they trade on their own. The full price Sam faces rises to 0.8 bars, the net price Joe collects falls to 0.4, and only the bottles whose gap in worths covers that spread change hands: trade runs to 5 bottles instead of 10, and the band between the two price lines is value the costs eat. Let the newcomer do the arranging for 0.2 bars a bottle and trade expands again. Sam's full price falls to 0.7 and Joe's net rises to 0.5, the seven bars paid and five received of the camp story, bottle by bottle. Each man's gain grows even after the newcomer takes his cut. A middleman who lowers the cost of trading does not skim value from Sam and Joe; he hands back gains the costs were destroying, and cheaper middlemen carry the market toward the point where the worths meet.
...
You might expect a middleman to grab the goods and never return, or to water down the granola and keep the difference. He rarely does, and the reason is reputation. A trader who cheats a customer loses more than that customer: he gets a bad name that costs him far more future business than the one-time gain was worth. A good reputation is an asset worth protecting, so the discipline of repeat dealing keeps most middlemen honest without anyone having to police them.

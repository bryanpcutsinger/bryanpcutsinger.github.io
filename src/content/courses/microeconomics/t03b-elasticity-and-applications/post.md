...
<figure class="econ-figure" style="margin:1.5em 0;">
<iframe src="/teaching/microeconomics/t03b-elasticity-and-applications/figures/t03-elasticity-shifts-interactive.html" title="Toggle Supply or Demand: when gas stocks change, the price slides along one fixed demand line; when demand shifts against unchanged stocks, the price rises with no movement along any curve." loading="lazy" style="width:100%; max-width:640px; aspect-ratio:16/10; border:1px solid #e3ddd3; border-radius:4px; background:#f7f4ef; display:block; margin:0 auto;"><p><a href="/teaching/microeconomics/t03b-elasticity-and-applications/figures/t03-elasticity-shifts-interactive.html">Open the interactive figure directly</a> or <a href="/teaching/microeconomics/t03b-elasticity-and-applications/figures/t03-elasticity-shifts.svg">view the static figure</a>.</p></iframe>
<figcaption><strong>A price change from a supply shift is not the same as one from a demand shift.</strong> The Supply scene retells the gas-stocks story: three possible stock levels, one unchanged demand line, and a price that slides from its highest level under low stocks to its lowest under high stocks, always along the same line, which is why the dashed arrows run alongside the demand curve. Drag the point (or use the arrow keys) to move among the three stock levels. The Demand scene holds stocks fixed and shifts demand from the lower line to the higher one: the price rises at the very same quantity, and no movement along any curve occurs. If the frame does not load, <a href="/teaching/microeconomics/t03b-elasticity-and-applications/figures/t03-elasticity-shifts-interactive.html">open the interactive figure directly</a> or <a href="/teaching/microeconomics/t03b-elasticity-and-applications/figures/t03-elasticity-shifts.svg">view the static figure</a>.</figcaption>
</figure>

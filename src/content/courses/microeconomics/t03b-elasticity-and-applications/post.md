...
The figure below turns that tug-of-war into a picture. Before the price change the farmer is on the lower curve D₁: the price is P₁ and she consumes Q₁. Then the milk price rises to P₂, and because she owns so much milk, the higher price raises her wealth and shifts her whole demand curve right to D₂. Everything turns on how far the curve shifts. If the wealth effect outweighs the substitution effect, the shift is large, and at the higher price she consumes Q₂, more than Q₁. If the substitution effect outweighs the wealth effect, the shift is small, and the higher price carries her to a Q₂ below Q₁. Use the buttons to switch between the two cases. In both, every curve slopes down: what looks like an exception to the law of demand is a shift of the curve, not a curve sloping the wrong way.

...
<ul>
<li>Explain why adjustment grows with time, why the legal side of a tax does not determine its burden, and how relative elasticities predict the split.</li>
<li>Apply the elasticity rule to fixed land, including capitalization and the political pull toward immobile rather than mobile tax bases.</li>
<li>Trace a tax from a lone price-taker through a broad industry's short and long runs, using quasi-rent and capitalization to explain why the burden moves and why latecomers bear none.</li>
</ul>
</aside>
...
One more cost of the tax escapes the price split, and we treat it verbally. The tax shrinks the quantity of gasoline produced and consumed. Those gallons no longer made were worth more to buyers than the resources freed up are now worth in whatever else they make. That lost value is a real cost of the tax, on top of the money the government collects. Economists call it a deadweight loss; the plain statement is that some genuinely valued output is sacrificed, and that loss is nobody's revenue.
...
<h3>Key takeaways</h3>
<ul>
<li><strong>Time and relative elasticity determine incidence.</strong> Buyers and sellers adjust more fully over longer horizons; who writes the check does not matter, and the side less able to walk away bears more.</li>
<li><strong>Fixed land reveals the limiting case.</strong> With zero supply elasticity, the owner bears the whole tax through capitalization, which is why taxes gravitate toward immobile bases while mobile bases escape.</li>
<li><strong>Tax burdens travel and capitalize.</strong> A lone price-taker bears his whole tax; a broad tax falls first on quasi-rents and later mainly on consumers, while a late buyer pays the already-reduced asset price and bears none of the old tax.</li>
</ul>
</section>
</div>
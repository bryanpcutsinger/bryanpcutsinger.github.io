...
<ul>
<li>Explain why a price-searcher's marginal revenue lies below price, use marginal revenue equals marginal cost to find its profit-maximizing output and price, and explain why market power leaves valuable units unmade, since the seller stops where price still exceeds marginal cost.</li>
<li>Explain why the threat of entry, not the number of sellers, disciplines a seller, and identify a monopoly rent such as a taxi medallion or a stadium grant.</li>
<li>Explain price discrimination as equalizing marginal revenue across buyers who differ in price-sensitivity, then setting that common marginal revenue equal to marginal cost, and recognize everyday pricing, senior discounts, coupons, scholarships, as the same move.</li>
</ul>
</aside>
...
A price-taker faces a flat demand for its own output: at the market price it can sell all it wants without ever cutting the price. A *price-searcher* faces a demand curve that slopes downward, so to sell one more unit it has to lower the price; nobody hands it a price, it has to find one.
...
<figcaption><strong>Marginal revenue always lies below price, and bisects the gap to the axis.</strong> Drag the point along the demand (average revenue) curve. A second point rides the marginal-revenue line directly below it, at the same quantity; the gap between them is the markdown a seller takes on units already sold to move one more. The braces below the axis show the classic result: MR always cuts the horizontal distance from the price axis to demand exactly in half. If the frame does not load, <a href="/teaching/microeconomics/t08a-price-searchers/figures/t08-mr-demand-interactive.html">open the interactive figure directly</a> or <a href="/teaching/microeconomics/t08a-price-searchers/figures/t08-mr-demand.svg">view the static figure</a>.</figcaption>
</figure>
...
One consequence follows directly. A flat annual license fee, fixed regardless of quantity sold, changes neither marginal revenue nor marginal cost, so the seller does exactly what it did before and just earns less profit. A *per-unit* tax is different: it shifts marginal cost, so it does change price and output, a story we told when we covered competition and the tax wedge.
...
Because a price-searcher stops where marginal revenue equals marginal cost, and marginal revenue sits below price, it stops where the price still sits above marginal cost. Units worth more to consumers than they cost to produce go unmade.
...
Two cautions keep this honest. The benchmark is the competitive, price-taking outcome, where output is pushed until cost rises to meet price. And some of what looks like restricted output is really the cost of variety, smaller batches of differentiated products buyers paid for. The distortion is real but milder than it first looks, and tends to erode on its own.
...
A market is open when nothing but cost stands between a would-be competitor and entry, closed when entry is blocked by something else: a license, a patent, a franchise, a tariff, an acreage limit, a board that controls who may practice. The number of sellers today is not the issue; what disciplines a seller is the threat of who could enter tomorrow. An open market keeps a lone seller honest, since charging too much invites entry; a closed one lets the protected seller hold the price up and let costs drift, because the door stays locked.

So "the grocery business is a monopoly" and "medicine is a monopoly" are different claims: anyone with capital can open a grocery, so open entry disciplines the grocer, while a licensed physician passes through a gate the profession guards, so medicine is genuinely closed, and prices run higher and cost control runs looser there.
...
When a closed market pays the protected seller above what the work costs, that surplus has a name: a *monopoly rent*, collected not because value was created but because access has been artificially restricted. A taxi medallion that sells for a fortune, a license that lets a few firms supply a city, an exclusive grant to serve a stadium: each can throw off rents, a transfer from buyers won by locking the door. Monopoly rent is the one real exception to "every profit rewards moving resources to a higher-valued use": here the gain is contrived scarcity, not created value.
...
If the market is open, market power is a fast-melting asset. A price-searcher earning fat profits draws imitators, who copy the product and chip away at the demand facing the original seller, until entry pushes that profit down toward zero, where the price just covers full average cost.
...
<figcaption><strong>Entry erases the profit, but the marginal rule still rules the output.</strong> Imitative entry keeps shrinking the demand facing the seller until the demand curve just grazes the average-cost curve, driving price down to average cost and profit to zero, even though the firm still produces where marginal revenue equals marginal cost. Drag the slider (or tap "Before" / "Zero profit") to sweep entry forward and watch the profit rectangle collapse to nothing while the MR = MC point at 5 units never moves. <a href="/teaching/microeconomics/t08a-price-searchers/figures/t08a-ue19-5-interactive.html">Open the interactive figure directly</a> if the embed does not load; there is no separate static image for this figure; the frame above is the complete picture.</figcaption>
</figure>

Where did the profit go? Partly it is competed away in lower prices, and partly it is absorbed into costs: if a prime location, a star chef, or a skilled manager made the profits, competitors bid up the price of that scarce ingredient until the extra earnings show up as a cost of hiring it rather than as profit. This is the same absorption-into-costs idea we met before, applied to market power. Sustained, comfortable profit is a symptom of a closed market.

### Cartels Are Unstable Because Every Member Has a Reason to Cheat

Now suppose several firms try to behave like a single monopolist: agree to hold output down and prices up, sharing the gains a monopolist would earn. That is a *cartel*, and the striking fact about cartels is how reliably they fall apart on their own.
...
Price discrimination is the pricing tactic that makes market power interesting: charging different buyers different prices for essentially the same thing. The name sounds sinister; the mechanics are not. A seller with two groups of buyers who differ in price-sensitivity earns more by charging each its own price, the rule being to equalize marginal revenue across the groups, then produce where that common marginal revenue equals marginal cost. Work it through with two customers, A and B.
...
<h3>Key takeaways</h3>
<ul>
<li><strong>Market power leaves valuable units unmade.</strong> A price-searcher's marginal revenue lies below price, so it maximizes profit where marginal revenue equals marginal cost, not where average cost is lowest, and stops where price still exceeds marginal cost, leaving units worth more than they cost to produce unproduced.</li>
<li><strong>Open or closed is what matters.</strong> Not the number of sellers but whether entry is blocked decides market power: an open market competes profit toward zero, while a closed market lets a protected seller collect a monopoly rent, such as a taxi medallion's premium.</li>
<li><strong>Price discrimination equalizes marginal revenue.</strong> Charging price-sensitive and price-insensitive buyers different prices, the same move behind senior discounts, coupons, and scholarships, raises revenue by shifting units toward the buyer with the higher marginal revenue until the margins are equal.</li>
</ul>
</section>
</div>
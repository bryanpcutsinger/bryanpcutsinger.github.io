...
Second, and this is the hinge of the whole topic, what makes market power durable and costly is not the number of sellers but whether the market is *open* or *closed*. A market is open when nothing but cost stands between a would-be competitor and entry; it is closed when entry is blocked by something else: a license, a patent, a tariff, an acreage cap. An open market keeps even a lone seller honest, because charging too much invites entry; a closed market lets the protected seller hold prices up, because the door behind it is locked, usually by government rather than by the market. Firms sometimes try to fake a closed market by colluding into a *cartel*, but a purely private cartel tends to cheat itself to death unless the law enforces it. Keep that open-versus-closed distinction in hand; everything in this post turns on it.
...
<ul>
<li>Judge an antitrust practice by whether it raises or lowers the worth delivered to consumers, rather than by concentration, labels, or whether competitors survive.</li>
<li>Explain regulatory capture from concentrated benefits and dispersed costs, including why regulation can become protection for incumbents and an off-budget tax on the public.</li>
<li>Explain why durable cartels and producer protections require government enforcement, and diagnose a farm program by its mechanism, outcome, beneficiaries, and payers.</li>
</ul>
</aside>
...
<iframe src="/teaching/microeconomics/t08b-antitrust-regulation/figures/t08b-ue21-1-interactive.html" title="Cycle Seattle's five markets, or drag its base price, to see freight-linked prices move together" loading="lazy" style="width:100%; max-width:480px; aspect-ratio:4/5; border:1px solid #e3ddd3; border-radius:4px; background:#f7f4ef; display:block; margin:0 auto;"><p><a href="/teaching/microeconomics/t08b-antitrust-regulation/figures/t08b-ue21-1-interactive.html">Open the interactive figure directly</a>.</p></iframe>
<figcaption><strong>Prices differ by city, but transport cost ties them together.</strong> Each market's price equals the production-site base price plus the freight it takes to get there, a pattern rather than an overcharge. Cycle the five markets, or drag the base price, to watch every city move together; that lockstep is why "phantom freight" names a competitive pattern, not a markup. If the frame does not load, <a href="/teaching/microeconomics/t08b-antitrust-regulation/figures/t08b-ue21-1-interactive.html">open the interactive figure directly</a>.</figcaption>
</figure>
...
<p class="econ-callout__label">Key term</p>
<dl class="econ-term-list">
<div><dt>Ricardian Rent</dt><dd>The higher earnings a superior or better-located resource collects because its services are worth more, not because entry into its market is blocked.</dd></div>
</dl>
</aside>

The plywood mills were in that same position. Being nearer the timber, they save on freight, and competition bids that saving into the value of their land and mills rather than into lower prices for local buyers. The jury looked at a competitive pattern and saw a conspiracy. But the differential the mills earned is a Ricardian rent, the ordinary return to a better location, not the monopoly rent from an artificial restriction on entry. Courts misreading the economics is the running theme of this whole section.

## Regulators Created to Restrain Monopoly Tend to Get Captured by It

The other policy lever is direct economic regulation: an agency that sets the prices and terms a firm may offer, usually justified as protecting consumers from a monopoly. Take that rationale seriously: some standardized services, such as electricity, water, gas, and local phone, are supplied more cheaply by one firm running a single system than by several firms stringing duplicate wires and pipes down the same street. Economists call that a *natural monopoly*, and it is why a local government deliberately creates a closed-market utility and then regulates it, to cap the price a lone supplier could charge and assure dependent customers reliable delivery at predictable prices. The rationale is real, but an agency built on it still drifts, and its core task, finding the "true" competitive price the missing market would have produced, is often impossible. The recurring result is the opposite of the intent, for a reason economists call *regulatory capture*.

<aside class="econ-callout econ-termset">
<p class="econ-callout__label">Key terms</p>
<dl class="econ-term-list">
<div><dt>Natural Monopoly</dt><dd>A service supplied more cheaply by one firm running a single system than by several firms duplicating it.</dd></div>
<div><dt>Regulatory Capture</dt><dd>The tendency of an agency to end up serving the firms it regulates rather than the public it was meant to protect.</dd></div>
</dl>
</aside>

The logic is about who pays attention. The public a regulator protects is large, diffuse, and lightly affected per person, and the crusaders who created the agency win their headline and move on; the regulated firms are few, intensely affected, and permanently engaged, so over time they dominate its hearings, staff, and rule-making, and the regulator drifts from restraining the incumbents toward shielding them from newer, more efficient rivals. The agency that was supposed to hold prices down for consumers ends up holding competitors out for producers.
...
Sincere consumer protection still faces a two-error tradeoff. A drug regulator can approve a harmful medicine too soon or delay a beneficial medicine too long; reducing either error generally raises the risk of the other, so "more caution" is not costless. Safety rules can also induce *offsetting behavior*: when a device lowers the perceived danger of an activity, people may drive faster or take other risks, giving back part of the engineering gain.

The consumer-protection label also creates an incumbent advantage. Restrictions on margarine, Sunday sales, advertising, and entry into medicine were defended as shields for buyers or community standards, yet each also protected established sellers from a cheaper product, a more convenient seller, or a new practitioner. Grandfathering incumbents is the clearest tell: a rule that exempts the people already supplying the allegedly dangerous service is poorly designed as a competence test and well designed as an entry barrier.

Nor should regulation's cost be measured by the agency's budget alone. When a rule makes firms redesign products, keep records, or wait for approval, those compliance costs are real resources the policy absorbs though they never appear as government spending. Regulation can operate like an off-budget tax, its burden falling through higher prices or forgone output while the official budget records only the administrators' salaries.

<aside class="econ-callout econ-check">
<p class="econ-callout__label">Pause and check</p>
<p>The Interstate Commerce Commission was created to hold railroad rates down, yet it later used its power to hobble the truckers competing with the railroads. Whose interest did the agency end up serving, and why does the diffuse public tend to lose this tug-of-war to the concentrated firms?</p>
</aside>

A close cousin of capture is the case for prohibiting particular marketing tactics, "predatory pricing" above all. The theory says a deep-pocketed giant prices below cost to bankrupt rivals, then jacks prices up once alone; it sounds plausible and almost never happens. The predator loses money heavier than its smaller prey while the war lasts; the bankrupt firm's plant and workers do not vanish, they get bought cheaply and re-enter with lower costs; and recoupment afterward requires barriers to entry an open market does not supply. A lower price from a genuinely lower-cost entrant is not predation but efficient competition, and a price below a rival's long-run cost can be efficient too, once sunk investment is in the picture: an old telephone company whose copper wire is fully sunk needs only $200 a channel to keep operating, while a newcomer's fiber would cost $675 a channel all-in. Old, with a short-run floor of just $200, can ride the price far below New's $675 long-run cost and keep operating on its sunk wire, which reflects sunk capacity, not predation. And the cost a regulator must find to set a "fair" price often does not exist: an off-peak kilowatt-hour and a peak one differ many times over, as California's 2001 blackouts showed when capped average-cost rates met above-average generation cost.

## The Same Price Jump Can Tell Three Different Stories

The 1973–74 oil-price jump illustrates why a price pattern alone cannot diagnose its cause. A cartel is one possible reading, but it faces the usual problem that every member gains by cheating. A change in ownership can also raise today's price without collusion when secure owners hold oil for a more valuable future instead of pumping rapidly under insecure concessions.
...
<figure class="econ-figure" style="margin:1.5em 0;">
<iframe src="/teaching/microeconomics/t08b-antitrust-regulation/figures/t08b-ue21-2-interactive.html" title="Drag the dominant firm's output to see marginal revenue meet marginal cost, and the resulting price rise above the price-taking level" loading="lazy" style="width:100%; max-width:520px; aspect-ratio:4/5; border:1px solid #e3ddd3; border-radius:4px; background:#f7f4ef; display:block; margin:0 auto;"><p><a href="/teaching/microeconomics/t08b-antitrust-regulation/figures/t08b-ue21-2-interactive.html">Open the interactive figure directly</a>.</p></iframe>
<figcaption><strong>When many small firms give way to one dominant seller, the price rises above the price-taking level.</strong> Facing the residual demand left after the small fringe firms supply what they will, the dominant firm sets output where its own marginal revenue meets its marginal cost. Drag the output handle to watch marginal revenue and marginal cost converge at the optimum: the dominant price Pd lands above the old price-taker price Pt, while total output falls below the old price-taker quantity Qt. If the frame does not load, <a href="/teaching/microeconomics/t08b-antitrust-regulation/figures/t08b-ue21-2-interactive.html">open the interactive figure directly</a>.</figcaption>
</figure>
...
Private cartels are unstable because each member can gain by secretly cutting price and a high cartel price invites entry. Government can solve both problems: it can require participation, restrict imports, cap acreage or output, and deny licenses to entrants. The longest-lived cartels are therefore not private agreements hiding from the state; they are restrictions enforced by it.
...
<aside class="econ-callout econ-check">
<p class="econ-callout__label">Pause and check</p>
<p>Alcoa was the only American maker of virgin aluminum for decades, yet it earned only a modest return and its prices fell over the years. What disciplined a lone seller with no direct rival, and why does its market share overstate its real power?</p>
</aside>

The doors that genuinely matter are the ones locked by law, the open-versus-closed hinge from Part A. Cost and risk are not locks; they are what competing has always meant.
...
<h3>Key takeaways</h3>
<ul>
<li><strong>Antitrust often protects competitors, not competition.</strong> The consumer-worth test asks whether a practice helps buyers, revealing why laws have punished lower prices, bulk discounts, and efficient scale.</li>
<li><strong>Regulators drift toward capture.</strong> Few permanently engaged firms organize against a diffuse public, so an agency built to restrain incumbents can shelter them and impose costs off-budget.</li>
<li><strong>Durable cartels are political arrangements.</strong> Government supplies the enforcement private cartels lack, while concentrated producer gains and dispersed consumer losses explain why restrictive farm programs persist.</li>
</ul>
</section>
</div>
...
<ul>
<li>Explain how futures and options transfer price risk, distinguish a two-sided hedge from insurance, and calculate an option's break-even price.</li>
<li>Explain how speculation and inventories smooth scarcity across time, and why a futures ban removes price information and hedging rather than the underlying uncertainty.</li>
<li>Explain how arbitrage and competitive prices allocate risk and information, why only news moves the unexpected price component in a random walk, and how diversification and intermediaries leave genuine uncertainty unresolved.</li>
</ul>
</aside>
...
Pull the threads together and a synthesis appears. The productivity of investment, people's time preference, the yield on bonds, the implicit return built into capital-good prices, these are not separate rates. Competition brings them all to a single common interest rate, meaning the same underlying risk-adjusted return before borrower-specific costs, default risk, inflation, maturity, and liquidity alter the observed package: if any asset offered a higher risk-adjusted return, buyers would pile in until its price rose and its return fell back into line. So when a question asks whether the interest rate is any one of these, the answer is that the common underlying return appears in all of them, held equal by competition even though quoted rates differ.

That equalization has a striking consequence for asset prices, and it is central to this topic. If all known information is already reflected in an asset's price, the *unexpected* part of tomorrow's return has no predictable direction. Today's price compounded at the required return is the unbiased estimate of tomorrow's price; in the short-period classroom model that sets ordinary interest aside, this simplifies to using today's price itself. Departures from that expected path come only from genuine *news*, and news, by definition, is unpredictable; if it were foreseeable it would already be in the price. So the unexpected component follows a *random walk*, moving up and down with no exploitable pattern. Flip this around and several puzzles dissolve. After a hundred coin-toss bets, the best prediction of your accumulated winnings is wherever you happen to stand right now, not zero and not the starting point; the past sequence tells you nothing about the next step. If half the brokers say a stock is too high and half say too low, that is exactly what a sensible market price looks like: the price sits right at the dividing line of opinion, and only new information moves it. Knowing that one stock rose 10 percent last month and another fell 10 percent gives you no edge in picking the next winner, because that history is already in both prices.
...
<h3>Key takeaways</h3>
<ul>
<li><strong>Futures and options transfer price risk.</strong> A futures hedge trades away a favorable move for protection against an unfavorable one, while an option adds one-sided protection with a calculable break-even.</li>
<li><strong>Speculators move goods and information across time.</strong> Inventory smooths scarcity between harvests, and banning futures trading removes a public forecast and hedging without removing speculation or uncertainty.</li>
<li><strong>Competitive finance allocates risk without abolishing uncertainty.</strong> Arbitrage pulls returns together and prices absorb known information. Only news moves the unexpected price component in a random walk; diversification avoids bets on that news, and intermediaries match liquid savings with long-term uses.</li>
</ul>
</section>
</div>
---
title: "Public Goods, Commons, and Institutional Choice"
topic: "T5 — Property Rights, Externalities, and Public Goods (Part B)"
course: "Principles of Microeconomics (FAU)"
sessions: ["Fall 2026 — content session 9 (Tue 9/22)"]
ue_anchors: ["UE 13 (public goods, clubs, commons, institutional remedies)"]
be_anchors: []
...
# brief: ../t05-property-rights-externalities/brief.md
---
...
<ul>
<li>Define a public good by nonrivalry, explain the free-rider problem, and compare government provision, clubs, and tie-in financing.</li>
<li>Explain why open-access common-pool resources are harvested too early and used too intensively, and why ownership changes that timing.</li>
<li>Compare institutional remedies by tracing decision-makers' incentives and who actually receives the benefit and bears the full cost.</li>
</ul>
</aside>
...
<div><dt>Nonrivalry</dt><dd>One person's use does not reduce the amount available to another.</dd></div>
<div><dt>Free Rider</dt><dd>A beneficiary who can enjoy a good without helping pay for it.</dd></div>
<div><dt>Common-Pool Resource</dt><dd>An open-access resource depleted by each user's consumption.</dd></div>
</dl>
</aside>
...
<p>A radio broadcast is nonrival and difficult to exclude non-payers from. How does advertising operate as a tie-in, and what payment does the listener actually make?</p>
</aside>
...
Notice what stands behind that administrator. In a nonprofit or a government agency, no one owns the residual: no one can sell the assets or pocket the gains, so its operators have weaker reason to heed the marketable value of what they do. And where a private owner has one sharp target, profit, such a body is handed an ambiguous one, to "maximize public welfare," with no crisp test of whether it is doing its job. Less able to price to clear, it is more prone to chronic shortages or surpluses and to nonprice rationing among buyers. The Postal Service is the clean illustration. It is built to [pay its own way](https://facts.usps.com/0-tax-dallars/): by its own account it "generally receives no tax dollars for operating expenses," and Congress shields its carriage of letters with a monopoly the GAO valued near $5.45 billion in fiscal 2015. Yet no one can claim the residual, and no bankruptcy or takeover forces a reckoning. It has [lost money in every fiscal year but one since 2007](https://www.gao.gov/products/gao-26-109008), about $118 billion in cumulative losses, including [$9.5 billion in fiscal 2024](https://news.usps.com/2024/11/14/usps-reports-year-end-financial-results/), and the GAO has kept its finances on the federal High-Risk List since 2009. Most of that loss traces to legislated pension and benefit accounting, not everyday waste; the structural point is that where no owner gains from closing the gap between cost and value, nothing forces it closed.
...
There is a rhetorical hazard here too. Because so many goods carry some public-good character, "this is a public good" is an argument available to almost any group that wants a subsidy. Because the label can support both genuine shared-benefit arguments and efforts by groups to secure subsidies, the label alone cannot reveal the motive or select the remedy. And public-good features settle nothing by themselves, since plenty of goods that have them are supplied privately anyway: broadcast television, and ideas, which patents and copyrights fence off well enough to sell.
...
<h3>Key takeaways</h3>
<ul>
<li><strong>Public goods create a payment problem.</strong> Nonrival use and difficult exclusion invite free riding; government finance, clubs, and tie-ins reconnect benefits with payment in different ways.</li>
<li><strong>Open-access commons are overused.</strong> Each user captures the current gain while spreading the future loss, whereas an owner preserves the asset's capitalized future value.</li>
<li><strong>No institutional remedy is free.</strong> Ownership, pricing, disclosure, regulation, and public provision create different incentives, and political labels do not reveal who ultimately benefits or pays.</li>
</ul>
</section>
</div>
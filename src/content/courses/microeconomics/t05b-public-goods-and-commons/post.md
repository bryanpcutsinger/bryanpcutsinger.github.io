...
be_anchors: []
ep_anchors: ["E&P ch. 5 & 18 — vertical summation of public-good values; public-goods rhetoric as subsidy cover; nonprofit/government incentive distortions"]
...
<ul>
<li>Define a public good by nonrivalry and distinguish it from a congestible or capacity-limited good.</li>
<li>Explain the free-rider problem and compare government provision, clubs, and tie-in financing.</li>
<li>Explain why open-access common-pool resources are harvested too early and used too intensively.</li>
<li>Compare ownership, pricing, disclosure, regulation, and collective provision as institutional remedies.</li>
<li>Explain why the remedy selected depends on political incentives and on who bears concentrated or dispersed costs.</li>
</ul>
</aside>
...
<h3>Key takeaways</h3>
<ul>
<li><strong>A public good is nonrival.</strong> One person's use does not reduce what remains for another, though production still consumes scarce resources.</li>
<li><strong>Free riding is a payment problem.</strong> Government finance, excludable clubs, and tie-ins are different ways to connect benefits with payment.</li>
<li><strong>Open-access commons are overused.</strong> Each user captures the current gain while the future loss is spread across everyone.</li>
<li><strong>Institutions must fit the resource.</strong> Ownership, access prices, disclosure, permits, regulation, and public provision solve different control and information problems.</li>
<li><strong>Remedy choice is political.</strong> Concentrated stakes organize more readily than dispersed ones, so the selected rule may differ from the rule with the largest total gain.</li>
</ul>
</section>
</div>